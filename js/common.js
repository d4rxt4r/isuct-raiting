	...
	$.getJSON(
		...
		function(data) {
            ...
            for (i = 0; i < records.length; i++) {
                ...
                subjectCard.querySelector('.term').innerText = records[i].querySelector('td:nth-child(1)').innerText;
                subjectCard.querySelector('.subjectTitle').innerText = records[i].querySelector('td:nth-child(2)').innerText;
                for (ii = 0; ii < 3; ii++) {
                    subjectCard.querySelectorAll('.mark')[ii].innerText = records[i].querySelector('td:nth-child('+ n +')').innerText;
                    n++;
                    subjectCard.querySelectorAll('.truancy')[ii].innerText = records[i].querySelector('td:nth-child('+ n +')').innerText;
                    n++;
                }
